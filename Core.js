...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Mád. to take your WhatsApp usage into next level.
...
reply(` Don't forget to join Mád. yeah!
...
case 'nsfwmenu':
    ...
    if (!AntiNsfw) return reply(mess.nonsfw)
        reply(` ولا تجعل الله أهون الناظرين إليك `)
    break
...
if (isBanChat) return reply(mess.bangc)
         reply(mess.waiting)
         let anu = await fetchJson('https://www.google.com/search?q=%D9%85%D9%88%D9%82%D8%B9+%D8%B5%D8%A9%D8%B1+%D8%AF%D9%8A%D9%86%D9%8A%D9%87&oq=%D9%85%D9%88%D9%82%D8%B9+%D8%B5%D8%A9%D8%B1+%D8%AF%D9%8A%D9%86%D9%8A%D9%87&aqs=chrome..69i57j69i61j35i39j0i131i433i512j0i433i512l2j0i131i433i512l2j0i512j0i131i433.1726j0j7&client=ms-android-oppo-rev1&sourceid=chrome-mobile&ie=UTF-8#ip=1')
...
I am *Mad.*, a bot developed by *Mád himself!"*.
...
self, public, ban, bangroup, bye, join, block, unblock, broadcast 
...
play, yts, google, playstore, gimage, pinterest, image, wallpaper, searchgc, happymod, wikimedia.
